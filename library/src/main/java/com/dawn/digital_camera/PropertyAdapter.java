...
public class PropertyAdapter<T> extends BaseAdapter {
    ...
    public PropertyAdapter(Context context, int imageViewResourceId, T[] images) {
        ...
        currentPosition = -1;
        selectedBackgroundColor = context.getResources().getColor(R.color.dc_selectedValueBackground);
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        try {
            ...
            Log.e("PropertyAdapter", "You must supply a resource ID for a ImageView");
            throw new IllegalStateException("PropertyAdapter requires the resource ID to be a ImageView", e);
        }
