...
public class PropertyDisplayer {
    ...
    public PropertyDisplayer(Context context, View container, LayoutInflater inflater, int property, int toggleBtnId,
        ...
        listContainer = (LinearLayout) inflater.inflate(R.layout.dc_property_listview, null);
    ...
    public void setPropertyDesc(int[] values, String[] valuesStrings, Integer[] icons) {
        ...
        if (icons != null) {
            ...
            adapter = new PropertyAdapter<Drawable>(context, R.layout.dc_property_icon_list_item, drawables);
        } else {
            String longest = "";
            int longestLength = 0;
            ...
            layoutListView(biggestValueWidth);
            adapter = new PropertyAdapter<String>(context, R.layout.dc_property_list_item, valuesStrings);
        }
