 ...
 */
package com.dawn.digital_camera.ptp;
...
import com.dawn.digital_camera.ptp.commands.GetDevicePropDescCommand;
import com.dawn.digital_camera.ptp.commands.InitiateCaptureCommand;
import com.dawn.digital_camera.ptp.commands.RetrieveAddedObjectInfoAction;
import com.dawn.digital_camera.ptp.commands.SimpleCommand;
import com.dawn.digital_camera.ptp.commands.nikon.NikonAfDriveCommand;
import com.dawn.digital_camera.ptp.commands.nikon.NikonCloseSessionAction;
import com.dawn.digital_camera.ptp.commands.nikon.NikonEventCheckCommand;
import com.dawn.digital_camera.ptp.commands.nikon.NikonGetLiveViewImageAction;
import com.dawn.digital_camera.ptp.commands.nikon.NikonGetLiveViewImageCommand;
import com.dawn.digital_camera.ptp.commands.nikon.NikonOpenSessionAction;
import com.dawn.digital_camera.ptp.commands.nikon.NikonStartLiveViewAction;
import com.dawn.digital_camera.ptp.commands.nikon.NikonStopLiveViewAction;
import com.dawn.digital_camera.ptp.model.DevicePropDesc;
...
public class NikonCamera extends PtpCamera {
    ...
    @Override
    public void onEventDirItemCreated(int objectHandle, int storageId, int objectFormat, String todo) {
    ...
    public void setLiveViewAfArea(float posx, float posy) {
        if (supportedOperations.contains(Operation.NikonChangeAfArea)) {
            ...
            queue.add(new SimpleCommand(this, Operation.NikonChangeAfArea, (int) centerx, (int) centery));
        }
    }
