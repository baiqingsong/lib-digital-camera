...
import com.dawn.digital_camera.ptp.commands.eos.EosAfDriveDeviceReadyCommand;
import com.dawn.digital_camera.ptp.commands.eos.EosEventCheckCommand;
import com.dawn.digital_camera.ptp.commands.eos.EosGetLiveViewPictureCommand;
import com.dawn.digital_camera.ptp.commands.eos.EosOpenSessionAction;
import com.dawn.digital_camera.ptp.commands.eos.EosSetLiveViewAction;
import com.dawn.digital_camera.ptp.commands.eos.EosSetPropertyCommand;
import com.dawn.digital_camera.ptp.commands.eos.EosTakePictureCommand;
...
public class EosCamera extends PtpCamera {
    ...
    @Override
    public void focus() {
        queue.add(new EosAfDriveDeviceReadyCommand(this, Operation.EosRemoteReleaseOn, 1, 0));
    }
    ...
    public void driveLens(int driveDirection, int pulses) {
        if (driveLensSupported && liveViewOpen) {
            ...
            queue.add(new SimpleCommand(this, Operation.EosDriveLens, value));
        }
    }
